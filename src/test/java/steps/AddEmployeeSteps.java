...
public class AddEmployeeSteps extends CommonMethods {
   ...
   //     addNewEmployeePage.middleName.sendKeys(middleName);
    ...
    public void capture_the_employee_id() {
        GlobalVariables.emp_Id=addNewEmployeePage.empIdLoc.getAttribute("value");
        GlobalVariables.firstName=addNewEmployeePage.firstName.getAttribute("value");
        System.out.println("Emp_id "+GlobalVariables.emp_Id);
        System.out.println("firstName "+GlobalVariables.firstName);
    }

    @Then("verify the results from UR and Backend")
    public void verify_the_results_from_ur_and_backend() {
